...
select customer_id,year(order_date),count(order_id) 'order count'
from sales.orders
...
select ca.category_id,max(list_price) 'max_list_price',min(list_price) 'min_list_price'
from production.categories ca inner join production.products pr
